...
class TodoListsControllerTest < ActionController::TestCase
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post :create, todo_list: { create_date: @todo_list.create_date, delete_flag: @todo_list.delete_flag, limit: @todo_list.limit, tag: @todo_list.tag, task_name: @todo_list.task_name }
    end
  ...
  test "should update todo_list" do
    patch :update, id: @todo_list, todo_list: { create_date: @todo_list.create_date, delete_flag: @todo_list.delete_flag, limit: @todo_list.limit, tag: @todo_list.tag, task_name: @todo_list.task_name }
    assert_redirected_to todo_list_path(assigns(:todo_list))
  end
